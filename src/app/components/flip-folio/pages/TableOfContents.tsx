...
type Page = 'cover' | 'toc' | 'about' | 'private-info' | 'education' | 'skills' | 'experience' | 'achievements' | 'projects' | 'contact';
...
const navItems = [
  ...
  { page: 'private-info' as Page, label: 'Private Sanctum', icon: Lock },
